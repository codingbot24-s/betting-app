...
func Buy(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Println("placing order for user id : ", userID)
	...
	fmt.Println("Order type is valid")
	fmt.Println("Validating order quantity")
	// check the quantity
	if order.Quantity <= 0 {
